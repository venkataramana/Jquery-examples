...
jQuery.fn.daterangepicker = function(settings){
	...
	var datepickerOptions = {
        ...
        var yrangeA=rangeA.substr(rangeA.length - 4);
        var yrangeB=rangeB.substr(rangeB.length - 4);
        var x=rangeA.substring(4,6);
        var y=rangeB.substring(4,6);
				...
				if(rangeInput.length == 2){
					...
					rangeInput.val((rangeA != rangeB && yrangeA <= yrangeB) ? rangeA+' '+ options.rangeSplitter +' '+rangeB : rangeA);
				}
